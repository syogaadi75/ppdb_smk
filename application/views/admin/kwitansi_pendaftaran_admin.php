...
<body onload="sub('print')">
  <div id="print">
    ...
    foreach ($data_print as $dp) {
      $nama = $dp->nama;
      $no_pendaftaran = $dp->no_pendaftaran;
      $tgl_lahir = $dp->tgl_lahir;
      $alamat = $dp->alamat;
      $kecamatan = $dp->kecamatan;
      $kota = $dp->kota;
      $asalsekolah = $dp->asalsekolah;
      $tmp_lahir = $dp->tmp_lahir;
      $p1 = $dp->prioritas1;
      $p2 = $dp->prioritas2;
      $p3 = $dp->prioritas3;
      $petugas = $dp->petugas;
      $uang_bayar = $dp->uang_pendaftaran;
    }

    $kembalian = $uang_bayar - 50000;
    ...
    <table align="center" style="width: 1100px; height: 70px; background-color: white;" class="font">
      ...
      <tr>
        <td style='width : 150px; text-align: left; '>Tempat,Tgl Lahir </td>
        <td> : <b><?php echo $tmp_lahir . ", " . date('d-m-Y', strtotime($tgl_lahir)); ?></b></td>
      </tr>
      <tr>
        <td style='width : 150px; text-align: left; '>Alamat </td>
        <td> : <b><?= $alamat; ?>, <?= $kecamatan; ?>, <?= $kota; ?></b></td>
      </tr>
      <tr>
        <td style='width : 150px; text-align: left; '>Asal Sekolah</td>
        <td> : <b><?php echo $asalsekolah; ?></b></td>
      </tr>
      <tr>
        <td style='width : 150px; text-align: left; '>Biaya Pendaftaran</td>
        <td> : &nbsp;<b>Rp <?php echo number_format(50000, 0, ',', '.'); ?></b></td>
      </tr>
      <tr>
        <td style='width : 150px; text-align: left; '>Bayar</td>
        <td> : &nbsp;<b>Rp <?php echo number_format($uang_bayar, 0, ',', '.'); ?></b></td>
      </tr>
      <tr>
        <td style='width : 150px; text-align: left; '>Kembalian</td>
        <td> : &nbsp;<b>Rp <?php echo number_format($kembalian, 0, ',', '.'); ?></b></td>
      </tr>
    </table>
    <table align="right" style="width: 330px; margin-top: -180px; margin-left: 200px;" class="font">
      ...
      <tr>
        <td>&nbsp;&nbsp;&nbsp;&nbsp;1. <b> <?php echo $p1; ?> </b></td>
      </tr>
      <tr>
        <td>&nbsp;&nbsp;&nbsp;&nbsp;2. <b> <?php echo $p2; ?> </b></td>
      </tr>
      <tr>
        <td>&nbsp;&nbsp;&nbsp;&nbsp;3. <b> <?php echo $p3; ?> </b></td>
      </tr>
      <tr>
        <br>
    </table>

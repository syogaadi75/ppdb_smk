                                        ...
                                        <div class="card-title mb-0 d-flex justify-content-between">
                                            <div>
                                                ...
                                                <small class="text-muted">
                                                    Data laporan pendaftaran, pencarian tanggal awal & akhir
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body pt-4">
                                        <form class="form-header" action="<?php echo base_url() . "C_admin/cari_laporan_pendaftaran"; ?>" method="POST">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo date('d M Y', strtotime($x->tgl_bayar)) ?></td>
                                                            <td><?php echo $x->nama; ?></td>
                                                            <td><?php echo $x->prioritas1; ?></td>
                                                            <td><?php echo $x->asalsekolah; ?></td>
                                                            <td><?php echo number_format($x->uang_pendaftaran); ?></td>
                                                            <td>
                                                                <center>
                                                                    <?php if ($x->uang_pendaftaran >= 50000) { ?>
                                                                        <button type="button" class="btn btn-outline-success" disabled="">Lunas</button>
                                                                    <?php } else { ?>

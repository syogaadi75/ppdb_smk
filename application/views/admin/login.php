<!DOCTYPE html>
<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="<?= base_url('assets/'); ?>assets/" data-template="vertical-menu-template-free">

<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />

  <title>Login | SMK PGRI 5 JEMBER</title>
          ...
          <div class="card-body">
            ...
            <div class="app-brand justify-content-center">
              <a href="<?= base_url(); ?>" class="app-brand-link">
                <div class="app-brand-logo demo d-flex align-items-center gap-2 flex-column">
                  <img width="50" src="<?= base_url(); ?>assets/images/logo.png" alt="Logo">
                  <div class="text-black"><strong>SMK PGRI 5 JEMBER</strong></div>
                </div>
              </a>
            </div>
            <!-- /Logo -->
            ...
            <form id="formAuthentication" class="mb-3" action="<?php echo base_url('C_proses_admin/login') ?>" method="POST">
              <div class="mb-3">

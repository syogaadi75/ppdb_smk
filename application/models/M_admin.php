...
class M_admin extends CI_Model{
	...
	function cek_siswa_jurusan($cari){
		return $this->db->query("SELECT reg_siswa.no_du,reg_siswa.no_pendaftaran,reg_siswa.tgl_du,calon.nama,calon.alamat,calon.tmp_lahir,calon.tgl_lahir,calon.asalsekolah FROM reg_siswa INNER JOIN calon ON reg_siswa.no_pendaftaran = calon.no_pendaftaran WHERE reg_siswa.paket_keahlian ='$cari'");
	} 
	function sekolah(){
